...
int main()
{
    ...
    DispatchIndirect dispatchIndirectData = { 10, 10, 1 };
    GLuint DIBO;
    glGenBuffers(1, &DIBO);
    glBindBuffer(GL_DISPATCH_INDIRECT_BUFFER, DIBO);
    glBufferData(GL_DISPATCH_INDIRECT_BUFFER, sizeof(DispatchIndirect), &dispatchIndirectData, GL_STATIC_DRAW);
